...
export const metadata = {
    title: "IdeaVault",
    description:
        "A secure platform for sharing and collaborating on innovative ideas, protected by advanced encryption and access controls."
}
    ...
    return (
        <html lang="en" data-theme="dark" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
            <body className="min-h-full flex flex-col bg-[#00170f]">
                <Navbar></Navbar>
                <div className="w-full md:max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8">{children}</div>
                <Footer></Footer>
