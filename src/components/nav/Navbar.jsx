    ...
    return (
        <div className="sticky top-0 z-50 py-4 bg-[#00170f]/85 backdrop-blur-xl border-b border-[#4edea3]/10 transition-all duration-300">
            <header className="w-full md:max-w-[80%] mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
                ...
                <nav className="hidden md:flex items-center gap-2 lg:gap-4">{navLinks}</nav>
                ...
                <div className="flex items-center gap-3">
                    <>
                        ...
                        {!user ? (
                            ...
                            <div className="flex items-center justify-center gap-2">
                                <Link
                                    href={"/profile"}
                                    className="w-10 h-10 rounded-full border border-[#4edea3]/30 p-0.5 hover:border-[#4edea3] hover:shadow-[0_0_15px_rgba(78,222,163,0.25)] hover:scale-105 transition-all duration-300 cursor-pointer"
                                >
                                    <Image
                                ...
                                <button
                                    ...
                                    className="w-20 bg-gradient-to-r from-[#4edea3] to-[#12a970] text-[#003824] font-['JetBrains_Mono',monospace] font-bold text-[14px] uppercase tracking-wider h-8 rounded-xl shadow-[0_0_20px_rgba(78,222,163,0.25)]  active:scale-[0.98] transition-all
                    ...
                    >
                        <span
                            className={`block w-5 h-[2px] bg-[#4edea3] rounded-full transition-all duration-300 origin-center ${
                                isMenuOpen ? "rotate-45 translate-y-[7px]" : ""
                            }`}
                        />
                        <span
                            className={`block w-5 h-[2px] bg-[#4edea3] rounded-full transition-all duration-300 ${
