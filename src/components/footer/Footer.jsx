        ...
        <footer className="w-full border-t border-[#4edea3]/10 bg-[#00120b] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-[40px] py-16 relative overflow-hidden">
            ...
            <div className="md:max-w-[80%] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div className="space-y-4">
                        <a href="#" className="flex items-center gap-2 group">
                            ...
                            <span className="font-['Geist',sans-serif] text-4xl font-extrabold text-[#b0f0d6] group-hover:text-[#4edea3] transition-colors duration-300">
                                Idea<span className="text-[#4edea3]">Vault</span>
                            </span>
                        </a>
                        <p className="font-['Geist',sans-serif] text-md leading-[20px] text-[#bbcabf] max-w-[240px]">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-2.5">
                            <a className="font-['JetBrains_Mono',monospace]  text-[#bbcabf] hover:text-[#4edea3] transition-colors duration-300 w-fit" href="#">Privacy Protocol</a>
                            <a className="font-['JetBrains_Mono',monospace]  text-[#bbcabf] hover:text-[#4edea3] transition-colors duration-300 w-fit" href="#">IP Protection</a>
                            <a className="font-['JetBrains_Mono',monospace]  text-[#bbcabf] hover:text-[#4edea3] transition-colors duration-300 w-fit" href="#">Terms of Sync</a>
                        </div>
                    </div>
                ...
                <div className="border-t border-[#4edea3]/5 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="font-['JetBrains_Mono',monospace]  tracking-[0.05em] text-[#bbcabf]">
